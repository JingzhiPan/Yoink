...
const api = {
  ...
  extractTweaks: (jobId: string, id: string, focus?: string): Promise<PatternMeta> => ipcRenderer.invoke('pipeline:tweaks', jobId, id, focus),
  applyTweaks: (id: string, values: Record<string, string>): Promise<void> => ipcRenderer.invoke('demo:applyTweaks', id, values),
