...
const KIND_LABEL: Record<Job['kind'], string> = { extract: '抽帧', parse: '解析', verify: '交叉核对', demo: '生成 demo', screenshot: '截图比对', feedback: '按反馈修改', consolidate: '合并校正 · 精简 spec', tweaks: '抽取 tweaks', skill: '打包 skill', retag: '整理标签' };
